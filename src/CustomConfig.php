...
namespace Josecl\PhpCsFixerCustomFixers;

use Josecl\PhpCsFixerCustomFixers\Fixer\UseSafeImport;
...
class CustomConfig extends Config
{
     ...
     */
    public function __construct(string $name = 'default', array $extraRules = [])
    {
        ...
        $rules = [
            ...
            ...$this->addSafeImportRuleIfAvailable(),
            ...$extraRules,
        ];
     ...
     */
    private function addSafeImportRuleIfAvailable(): array
    {
        if (empty(UseSafeImport::getSafeFunctionList())) {
            return [];
        }

        $this->registerCustomFixers([new UseSafeImport()]);

        return [
            'Safe/use_safe_import' => true,
            'ternary_to_null_coalescing' => true,
        ];
    }
}
